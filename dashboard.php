        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <p class="mb-4">Halaman Profile Dokter digunakan admin untuk menambah profile dokter.</p>
              <a href="profile-dokter" class="btn btn-success rounded-pill px-4 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>News</h3>
              <p class="mb-4">Halaman Kabar Berita digunakan admin untuk membuat konten terbaru artikel.</p>
              <a href="konten" class="btn btn-success rounded-pill px-4 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
